jQuery(document).ready(function($) {
   ...
   'use strict';
    ...
    $('#countdown').countdown({until: new Date(2019, 6 - 1, 10, 9, 0, 0, 0)}); // enter event day
...
$(window).load(function(){
    ...
    var myOptions = {
        zoom: 17,
        center: new google.maps.LatLng(39.891875, 32.783349), //change the coordinates
    ...
    marker = new google.maps.Marker({
        map: map,
        position: new google.maps.LatLng(39.891875, 32.783349) //change the coordinates
    });
    infowindow = new google.maps.InfoWindow({
        content: "<b>Department of Computer Engineering</b><br> Middle East Technical University <br> Universiteler Mah. Dumlupinar Blv. No:1"  //add your address
    });
